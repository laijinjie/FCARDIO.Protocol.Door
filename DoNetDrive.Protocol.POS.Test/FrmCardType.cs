...
using DoNetDrive.Protocol.POS.CardType.AddCardTypeDetail;
using DoNetDrive.Protocol.POS.CardType.ClearDataBase;
using DoNetDrive.Protocol.POS.CardType.DatabaseDetail;
