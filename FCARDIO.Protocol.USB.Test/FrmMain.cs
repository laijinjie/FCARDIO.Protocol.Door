...
using FCARDIO.Protocol.Door.OfflinePatrol.SystemParameter.SN;
...
namespace FCARDIO.Protocol.USB.Test
{
    public partial class FrmMain : Form, INMain
    {
        ...
        private static void IniCommandClassNameList()
        {
            ...
            mCommandClasss.Add(typeof(FCARDIO.Protocol.Door.OfflinePatrol.SystemParameter.SN.ReadSN).FullName, "读取SN");
        }
        ...
        public USBDriveCommandDetail GetCommandDetail()
        {
            ...
            SerialPortDetail portDetail = new SerialPortDetail(GetSerialPort());
            //CommandDetailFactory.CreateDetail(CommandDetailFactory.ConnectType.SerialPort,"",)
            //mAllocator
            USBDriveCommandDetail cmdDtl = new USBDriveCommandDetail(portDetail, 1);
            return cmdDtl;
        }
        #endregion
