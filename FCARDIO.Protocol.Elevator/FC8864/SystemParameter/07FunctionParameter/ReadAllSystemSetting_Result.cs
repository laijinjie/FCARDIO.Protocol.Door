...
namespace FCARDIO.Protocol.Elevator.FC8864.SystemParameter.FunctionParameter
{
    ...
    public class ReadAllSystemSetting_Result : INCommandResult
    {
        ...
        public ReadAllSystemSetting_Result(short _RecordMode, short _Keyboard,  short _FireAlarmOption, short _OpenAlarmOption, int _ReaderIntervalTime, BroadcastDetail _SpeakOpen, short _ReaderCheckMode, short _BuzzerMode, short _SmogAlarmOption,  TheftAlarmSetting _TheftAlarmPar, short _CheckInOut, short _CardPeriodSpeak, ReadCardSpeak _ReadCardSpeak)
        {
