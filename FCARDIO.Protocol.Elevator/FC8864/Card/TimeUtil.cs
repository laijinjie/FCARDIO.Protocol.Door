   ...
   public class TimeUtil
    {
        public static Calendar BCDTimeToDate_ssmmhhddMMyy(byte btTime[])
        {
            ...
            int month = ByteUtil.uByte(btTime);
            int dayOfMonth = ByteUtil.uByte(btTime);
            int hourOfDay = ByteUtil.uByte(btTime);
            int minute = ByteUtil.uByte(btTime);
            int second = ByteUtil.uByte(btTime);
