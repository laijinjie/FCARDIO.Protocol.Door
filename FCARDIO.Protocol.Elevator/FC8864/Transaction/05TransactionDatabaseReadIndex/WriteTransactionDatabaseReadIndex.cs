...
using FCARDIO.Protocol.Door.FC8800.Transaction.TransactionDatabaseReadIndex;

namespace FCARDIO.Protocol.Elevator.FC8864.Transaction.TransactionDatabaseReadIndex
{
    /// <summary>
    /// 更新记录指针
    /// </summary>
