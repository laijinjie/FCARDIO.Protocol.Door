...
using FCARDIO.Protocol.Door.OfflinePatrol.Data.Transaction;
using FCARDIO.Protocol.Door.OfflinePatrol.Transaction.TransactionDatabaseDetail;
...
namespace FCARDIO.Protocol.Door.OfflinePatrol.Transaction.ReadTransactionDatabase
{
    ...
    public abstract class ReadTransactionDatabase_Base : Read_Command
    {
        ...
        /// 选择的记录模块
        /// </summary>
        protected TransactionDetailBase transactionDetail;
        ...
        /// </summary>
        /// <param name="oPck"></param>
        private void ReadDataBaseDetailCallBack(USBDrivePacket oPck)
        {
        ...
        /// </summary>
        /// <param name="oPck"></param>
        private void ReadTransactionDatabaseByIndexCallBack(USBDrivePacket oPck)
        {
            ...
            else if (CheckResponse(oPck, 0x04, 0xff, 4))
            {
                ReadTransactionNext();
            }
        }
        ...
        /// </summary>
        /// <param name="oPck"></param>
        private void ReReadDatabaseCallBack(USBDrivePacket oPck)
        {
            if (CheckResponse(oPck))
            {
                var buf = oPck.CmdData;
            ...
            else if (CheckResponse(oPck, 6, 0xFF, 4))
            {
                //继续发送下一波
                //ReadTransactionNext();
                var buf = oPck.CmdData;
        ...
        private void ReadTransactionNext()
        {
            ...
            //mDictSerialNumber
            transactionDetail.ReadIndex = (uint)iEndIndex;//更新记录尾号
