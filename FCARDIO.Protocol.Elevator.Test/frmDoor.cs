...
namespace FCARDIO.Protocol.Elevator.Test
{
    public partial class frmDoor : frmNodeForm
    {
        ...
        private void DgvDoor2_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (e.ColumnIndex == 2)
            {
                DataGridViewComboBoxColumn combobox = dgvDoor2.Columns[e.ColumnIndex] as DataGridViewComboBoxColumn;
                if (combobox != null) //如果该列是TextBox列
                {
        ...
        private void DgvDoor3_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (e.ColumnIndex == 2)
            {
                DataGridViewComboBoxColumn combobox = dgvDoor3.Columns[e.ColumnIndex] as DataGridViewComboBoxColumn;
                if (combobox != null) //如果该列是TextBox列
                {
        ...
        private void DgvDoor4_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            if (e.ColumnIndex == 2)
            {
                DataGridViewComboBoxColumn combobox = dgvDoor4.Columns[e.ColumnIndex] as DataGridViewComboBoxColumn;
                if (combobox != null) //如果该列是TextBox列
                {
