...
namespace FCARDIO.Protocol.Door.FC8800.Door.ManageKeyboardSetting
{
    ...
    /// 读取键盘管理功能
    /// </summary>
    public class ReadManageKeyboardSetting : FC8800Command
    {
        ...
        {
            Packet(0x03, 0x15, 0x01, 0x01, GetCmdDate());
        }
        ...
        protected override void CommandNext1(OnlineAccessPacket oPck)
        {
            if (CheckResponse(oPck, 2))
            {
                ...
                ManageKeyboardSetting_Result rst = new ManageKeyboardSetting_Result();
                _Result = rst;
                rst.SetBytes(buf);
                CommandCompleted();
            }
