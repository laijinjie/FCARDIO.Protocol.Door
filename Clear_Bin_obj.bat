...
rd /s /Q DoNetDrive.Protocol.USB\CardReader\bin
rd /s /Q DoNetDrive.Protocol.USB\CardReader\obj
rd /s /Q DoNetDrive.Protocol.USB\OfflinePatrol\bin
rd /s /Q DoNetDrive.Protocol.USB\OfflinePatrol\obj
pause